...
--
-- Host: localhost
-- Tempo de geração: 22-Abr-2020 às 20:33
...
(11, '555.555-5', '555.555.555-55', '2T', 'VICTOR SHIGUEO SUGAHARA', 'SHIGUEO', 'e10adc3949ba59abbe56e057f20f883e', 'TESOU', 'Aprovado', '2020-03-16'),
...
(16, '777.777-7', '777.777.777-77', '2T', 'ISRAEL SAMPAIO', 'SAMPAIO', '202cb962ac59075b964b07152d234b70', NULL, 'Aguardando', '2020-04-11');
...
(19, 'ADICIONAL DE COMPENSAÇÃO ORGÂNICA', 'Aprovado');
...
INSERT INTO `tb_secoes_exant` (`id`, `secao`, `prazo_exant`, `status`) VALUES
(1, 'ACI-1', 10, 'Aprovado'),
(2, 'DP-1', 15, 'Aprovado'),
(3, 'DP-3', 10, 'Aprovado'),
(4, 'DP-4', 15, 'Aprovado'),
