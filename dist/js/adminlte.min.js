	...
	var e = (function(t) {
					...
					return (
						...
						(e._jQueryInterface = function(n) {
							return this.each(function() {
								var s = t(this).data(i);
								if (
									(s || ((s = new e(this, t(this).data())), t(this).data(i, s)),
									"undefined" === s[n])
								)
		...
		i = (function(t) {
			var e = "Layout",
				...
				f = "login-page",
				u = "register-page",
				g = { scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l" },
				_ = (function() {
					function e(t, e) {
					...
					return (
						(i.fixLayoutHeight = function() {
							var e = {
								...
								i = this._max(e);
							i == e.window
								? t(a).css("min-height", i - e.header - e.footer)
								: t(a).css("min-height", i - e.header),
								t("body").hasClass(h) &&
									(t(a).css("min-height", i - e.header - e.footer),
									"undefined" != typeof t.fn.overlayScrollbars &&
						...
						(i._init = function() {
							...
							if (
								...
								t("body").hasClass(f) || t("body").hasClass(u))
							) {
								if (t("body").hasClass(f) || t("body").hasClass(u)) {
									var i = t(l + ", " + c).height();
		...
		n = (function(t) {
				...
				c = (function() {
					...
					return (
						(n.show = function() {
							this._options.autoCollapseSize &&
								...
								this._options.enableRemember &&
									localStorage.setItem("remember" + i, l);
						...
						(n.collapse = function() {
							this._options.autoCollapseSize &&
								t(window).width() <= this._options.autoCollapseSize &&
								t(a.BODY).removeClass(l),
								t(a.BODY).addClass(r),
								this._options.enableRemember &&
									localStorage.setItem("remember" + i, r);
							var e = t.Event(s.COLLAPSED);
							t(this._element).trigger(e);
						}),
						(n.toggle = function() {
						...
						(n.autoCollapse = function() {
							this._options.autoCollapseSize &&
								(t(window).width() <= this._options.autoCollapseSize
									? t(a.BODY).hasClass(l) || this.collapse()
									: t(a.BODY).hasClass(l)
									? t(a.BODY).removeClass(l)
									: this.show());
						}),
			...
			return (
				t(document).on("click", a.TOGGLE_BUTTON, function(e) {
					...
					"pushmenu" !== t(i).data("widget") &&
						(i = t(i).closest(a.TOGGLE_BUTTON)),
				...
				l = (function() {
					...
					return (
						(i.collapse = function() {
							var e = this;
							this._parent
								.children(a.CARD_BODY + ", " + a.CARD_FOOTER)
						...
						(i.toggle = function() {
							this._parent.hasClass(o.COLLAPSED)
								? this.expand()
								: this.collapse();
						}),
						(i.maximize = function() {
								...
								this._parent
									...
									.queue(function() {
										t(this).addClass(o.MAXIMIZED),
											...
											t(this).hasClass(o.COLLAPSED) &&
												t(this).addClass(o.WAS_COLLAPSED),
											t(this).dequeue();
									});
								...
								this._parent
									...
									.queue(function() {
										t(this).removeClass(o.MAXIMIZED),
											...
											t(this).hasClass(o.WAS_COLLAPSED) &&
												t(this).removeClass(o.WAS_COLLAPSED),
											t(this).dequeue();
									});
						...
						(i.toggleMaximize = function() {
							this._parent.hasClass(o.MAXIMIZED)
								? this.minimize()
								: this.maximize();
						}),
						(i._init = function(e) {
						...
						(i._prepareContainer = function() {
							if (0 === t(this._getContainerId()).length) {
								...
								this._config.position == f
									...
									: this._config.position == g
									? e.addClass(d)
									: this._config.position == _ && e.addClass(h),
									t("body").append(e);
							}
							this._config.fixed
