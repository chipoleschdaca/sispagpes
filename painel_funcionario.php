    ...
    <div class="wrapper">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                <i class="nav-icon far fa-hand-point-right text-danger"></i>
                <p class="text">Important</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">
                <i class="nav-icon far fa-hand-point-right text-warning"></i>
                <p>Warning</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">
                <i class="nav-icon far fa-hand-point-right text-info"></i>
                <p>Informational</p>
              </a>
            </li>
          </ul>
